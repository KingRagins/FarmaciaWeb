...
if (isset($_GET['busqueda']) && !empty($_GET['busqueda'])) {
    ...
    // Buscar en nombre, descripción y categoría (si tienes la tabla categorías unida)
    $where_condition = "WHERE (nombre LIKE '%$busqueda%' 
...
<head>
    ...
    <title>Catalogo de productos<?php echo $busqueda ? " - Búsqueda: $busqueda" : ''; ?></title>
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse p-2 text-white" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 ">
                <li class="nav-item">
                    <a class="nav-link" href="login_register_user.php" id="iniciar_sesion">
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">
                ...
                <?php else: ?>
                    Farmamigo IV, tu farmacia de confianza
                <?php endif; ?>
            </h1>
            ...
            <?php if ($busqueda): ?>
                <a href="catalogo.php" class="btn btn-outline-light mt-3">Ver todos los productos</a>
            <?php endif; ?>
        </div>
    </div>
</header>
                        ...
                        <div class="col mb-5">
                            <div class="card h-100 text-white" id="carta_producto">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a class="btn btn-outline-dark mt-auto" href="login_register_user.php">Ver producto</a>
                                    </div>
                                </div>
                            </div>
                        </div>
